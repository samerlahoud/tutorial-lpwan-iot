...
pandoc --latex-engine=xelatex -t beamer front-matter.md back-matter.md -H ./generation-script/in_header.txt -o /Users/simurgh/Desktop/lpwan-iot-tutorial-ict-18.pdf
echo "magic is done!"
