...
pandoc --latex-engine=xelatex -t beamer front-matter.md general-framework.md perf-evaluation.md -H ./generation-script/in_header.txt -o lpwan-iot-tutorial-ict-18.pdf
echo "magic is done!"
