...
pandoc --pdf-engine=xelatex -f markdown+raw_tex -t beamer front-matter.md design-rationales.md technical-specs.md link-perf-evaluation.md -H ./generation-script/in_header.txt -o nbiot-tutorial-5gwf-19.pdf
