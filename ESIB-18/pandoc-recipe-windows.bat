...
pandoc --latex-engine=xelatex -t beamer front-matter.md design-rationales.md technical-specs.md -H ./generation-script/in_header.txt -o lpwan-iot-tutorial-esib-18.pdf
